...
const DICTIONARY = {
  ...
  'l2d.stageTitle': { zh: '舞台 · 物理与背景', en: 'STAGE · PHYSICS & BACKGROUND' },
  'l2d.fpsOverlay': { zh: 'FPS 角标显示', en: 'FPS Overlay' },
  'l2d.fpsOverlayDesc': { zh: '在执行器窗口左上角常驻显示帧率', en: 'Always show FPS at the executor window corner' },
  'l2d.windX': { zh: '风力 X', en: 'WIND X' },
  'l2d.windY': { zh: '风力 Y', en: 'WIND Y' },
  'l2d.gravityX': { zh: '重力 X', en: 'GRAVITY X' },
  'l2d.gravityY': { zh: '重力 Y', en: 'GRAVITY Y' },
  'l2d.physicsSpeed': { zh: '物理强度', en: 'PHYSICS STRENGTH' },
  'l2d.bgSection': { zh: '背景', en: 'BACKGROUND' },
  'l2d.bgTransparent': { zh: '透明', en: 'TRANSPARENT' },
  'l2d.bgColorMode': { zh: '颜色', en: 'COLOR' },
  'l2d.bgImageMode': { zh: '图片', en: 'IMAGE' },
  'l2d.bgAlpha': { zh: '不透明度', en: 'OPACITY' },
  'l2d.bgUpload': { zh: '上传背景图', en: 'UPLOAD IMAGE' },
  'l2d.bgClear': { zh: '清除背景', en: 'CLEAR' },
  'l2d.stageHint': { zh: '以上配置与模型窗口悬浮面板双向联动：任意一端修改，另一端即时同步。', en: 'These settings sync two-way with the floating panel on the model window.' },
